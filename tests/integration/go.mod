module github.com/sentinel-device-manager/tests/integration
...
require (
	...
	github.com/sentinel-device-manager/backend/go v0.0.0
)
...
replace github.com/sentinel-device-manager/backend/go => ../../backend/go
